###########################################################################
# Created by: zuoyu zhou
# Email: zuoyu@hust.edn.cn
# Copyright (c) 2019
###########################################################################
...
class Trainer():
    def __init__(self, args):
        ...
        trainset = get_dataset(args.dataset, split='train', mode='train',
                                            **data_kwargs)
        ...
        if args.ft:
            ...
            self.logger.info("=> loaded checkpoint '{}' (epoch {})".format(args.ft_resume, args.start_epoch))
        # resuming checkpoint
        if args.resume:
    ...
    def training(self, epoch):
        ...
        for i, (image, target, depth, HHA) in enumerate(tbar):
